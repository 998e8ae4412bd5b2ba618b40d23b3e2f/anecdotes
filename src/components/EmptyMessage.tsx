...
const EmptyMessage = ({title, content, linkTitle, linkUrl, classname}: IEmptyMessage) => {
    return (
        <div
            className={`rounded-[20px]  flex-col justify-center shadow-none items-center gap-[50px] max-w-[470px] w-full ${classname}`}
        >
            <div className="bg-white p-8 rounded-[20px]">
                ...
                <div className="flex flex-wrap md:flex-nowrap w-full pt-8 gap-4">
                    ...
                    >
                        {linkTitle ? linkTitle : 'Знайти анкдот'}
                    </Link>
                </div>
            </div>
        </div>
