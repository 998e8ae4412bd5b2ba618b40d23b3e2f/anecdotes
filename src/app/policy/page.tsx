...
const Page = () => {
    return (
        <div className="max-w-3xl mx-auto p-6 bg-white text-gray-900 shadow-lg rounded-lg mt-10">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Website</strong> refers to eAnectotes, accessible from <a href="https://yeanecdoty.com/"
                                                                                         rel="external nofollow noopener"
                                                                                         target="_blank">https://yeanecdoty.com/</a>
                    </p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: yeanecdoty@gmail.com</li>
            </ul>
        </div>
    );
};
